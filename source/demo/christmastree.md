...
<html>
	<head>
		<meta charset="utf-8">
		<title>番茄酱的Blog | 仅使用 CSS 制作的动画圣诞树</title>
		<meta name="viewport" content="width=device-width,initial-scale=1.0,maximum-scale=1.0,minimum-scale=1.0,user-scalable=0">
		<meta name="keywords" content="番茄酱" />
		<meta name="author" content="番茄酱的Blog(https://blog.aidengrong.top)" />
		<meta name="copyright" content="番茄酱的Blog(https://blog.aidengrong.top)" />
		<link rel="icon" href="https://blog.aidengrong.top/img/christmastree.webp" sizes="192x192" />
		<style>
			@charset "UTF-8";
			h1, body {
	...
	<body>
		...
		<a href="https://blog.aidengrong.top/" target="_blank" class="btn btn_right" id="fullscr">番茄酱的Blog</a>
		<script>
			//禁用操作
