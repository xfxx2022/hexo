...
![WoTerm](https://blog.aidengrong.top/img/2022/12/11/vnc.png)![WoTerm](https://blog.aidengrong.top/img/2022/12/11/vnc2.png)
...
* 支持关键字搜索过滤，极速定位目标项。
* 支持中英文语言选择。
* 支持VNC远程桌面访问功能，高级功能需要与[WoVNC](https://gitee.com/link?target=http%3A%2F%2Fwovnc.com)服务端才支持。
...
{% btn 'https://www.123pan.com/s/CDiA-LdOF3',123盘,iconfont icon-tianmao123shixiao,blue larger %}
{% btn 'https://wwtu.lanzoub.com/b037rem2b',蓝奏网盘,iconfont icon-yunpan,pink larger %}
</div>
