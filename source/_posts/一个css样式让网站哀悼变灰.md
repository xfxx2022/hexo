...
categories:
  - - 教程
cover: 'https://blog.1314151.xyz/img/2022/12/11/huise.webp'
...
grayscale() : 对图片进行灰度转换，grayscale是 <filter-function> 的子属性，当100%参数时候的效果如下：![huise](https://blog.1314151.xyz/img/2022/12/11/huise.webp)最简单地把页面的<html>开始标签中间之间加：
